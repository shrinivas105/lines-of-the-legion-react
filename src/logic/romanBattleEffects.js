...
class RomanBattleEffects {
  ...
  // NOTE: commented out for now — no sound files (forward.mp3, attack.mp3,
  // fanfare.mp3, roman-ambient.mp3) are bundled in this project, so calling
  // `new Audio(...)` here would just 404. Re-enable once the actual audio
  // assets are added.
...
// (kept as in the original — unreferenced there too; preserved verbatim
// rather than removed, since this port avoids deleting any original code)
...
export { RomanBattleEffects };
export default RomanBattleEffects;
